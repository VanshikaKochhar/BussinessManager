...
public class ServicesHelp extends JFrame implements ActionListener
{
    ...
    public ServicesHelp()
    {
        ...
        BackButton.setBounds(754,0,46,40);
        ...
        // Background Image
        bg = new JLabel("");
        bg.setIcon(new ImageIcon(this.getClass().getResource("/ServicesHelp.jpeg")));
