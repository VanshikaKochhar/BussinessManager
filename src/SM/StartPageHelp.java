...
public class StartPageHelp extends JFrame implements ActionListener
{
    ...
    public StartPageHelp()
    {
        ...
        // Background Image
        bg = new JLabel("");
        bg.setIcon(new ImageIcon(this.getClass().getResource("/StartHelp.jpeg")));
